      ...
      <div class="columns" style="width: 100%">
        <div class="column">
          <b-breadcrumb
              align="is-left"
          >
            <b-breadcrumb-item tag='router-link' to="/bank" >Bank</b-breadcrumb-item>
    ...
    <div class="card-content" style="overflow: auto; height: 70vh">
      <section>
        ...
        <b-field
          ...
          <b-input @blur="bankData.bank_code.blur()" v-model="bankData.bank_code.value" maxlength="100" expanded></b-input>
        </b-field>
...
export default {
  ...
  methods: {
    ...
    validateAndSubmit: function (){
      ...
      if(self.validate()){
        ...
        NetworkManager.apiRequest('api/dutyfree/DFBank/create', data, function (e){
          if(e.statusCode === 200){
            const params = {
              type: 'is-success',
  ...
  mounted() {
    this.bankData.disabled.value = 0
  }
}
</script>
