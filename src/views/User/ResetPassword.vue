<template>
  <section class="hero is-fullheight">
    <!-- <terms-and-conditions-modal ref="modalComponent" @accepted="handleAccepted"></terms-and-conditions-modal> -->
  ...
  methods: {
    ...
    resetPassword: function (){
      ...
      if(self.validate()){
        ...
        NetworkManager.apiRequest('api/dutyfree/DFUser/reset-password', data, function (e){
          if(e.statusCode === 200){
            const params = {
              type: 'is-success',
...
//     handleAccepted() {
//       const  self = this
//       self.$refs.modalComponent.modalActive = false; 
// },
  },
