<template>
  <div class="card" style="margin: 10px;  min-height: 300px">
    <div class="card-content">
      <div class="columns">
        <div class="column is-three-fifths" style="font-weight: bold; margin-left: 10px">Duty Free Requests - Customers</div>
  ...
  data() {
    return {
      ...
      chartOptions: {
        ...
        labels: ['Total Number of Requests', 'Responded Requests', 'Pending Requests'],
        legend: {
          position: 'left',
        },
        title: {
