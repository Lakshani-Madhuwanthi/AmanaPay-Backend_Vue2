<template>
  <div class="card" style="margin: 10px;  min-height: 300px">
    <div class="card-content">
      <div class="columns">
        <div class="column is-three-fifths" style="font-weight: bold; margin-left: 10px">Range Of Duty Free Claimed</div>
  ...
  methods: {
    ...
    loadData: function () {
      ...
      setTimeout(() => {
        ...
        NetworkManager.apiRequest('api/DFDashboard/Dutyfree-allowance-criteria', data, function (e) {
          if (e.statusCode === 200) {
