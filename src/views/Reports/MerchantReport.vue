  ...
  <section>
      ...
      <div class="columns" style="width: 100%">
        <div class="column">
          <b-breadcrumb
              align="is-left"
          >
            <b-breadcrumb-item tag='router-link' to="" active >Merchant Report</b-breadcrumb-item>
          </b-breadcrumb>
        </div>
        <div class="column">
        </div>
    ...
    <div class="card-content" style="overflow: auto; height: 83vh">
      <div class="columns" style="margin-top: 10px">
        ...
        <b-field class="column is-one-fifths is-small" label="Merchant Reg No" label-position="on-border">
          <b-input v-model="regNo" @blur="regNo = regNo.trim()" maxlength="30" size="is-small"></b-input>
        </b-field>
      ...
      <b-table
        ...
        <b-table-column field="reg_no" label="Reg No" sortable numeric v-slot="props" centered>
          {{ props.row.reg_no }}
        </b-table-column>

        <b-table-column field="merchant" label="Merchant" width="200" sortable numeric v-slot="props" centered>
          {{ props.row.merchant }}
        </b-table-column>

        <b-table-column field="purchase_count" label="Purchase Count" width="200" numeric v-slot="props" centered>
        ...
        <b-table-column field="action" label="Action" sortable v-slot="props" width="200" centered>
          <b-button icon-left="list-box" @click="showPurchaseListModal(props.row)" type="is-primary" size="is-small"></b-button>
        </b-table-column>
      ...
      <template>
        <div class="modal-card" style="width: auto">
          <header class="modal-card-head">
            <p class="modal-card-title">{{selectedMerchant.merchant}} - Purchases List</p>
            <button
                type="button"
                class="delete"
          ...
          <section class="modal-card-body">
            <b-table
                ...
                :data="selectedMerchant.purchases"
                :paginated="tableOptions.isPaginated"
                :per-page="tableOptions.perPage"
                :current-page.sync="tableOptions.currentPage"
                :pagination-simple="tableOptions.isPaginationSimple"
              ...
              <b-table-column field="merchant" label="Merchant" width="200" numeric v-slot="props" >
                {{ props.row.merchant }}
              </b-table-column>

              <b-table-column field="invoice_number" label="Invoice Number" width="200" numeric v-slot="props" >
                {{ props.row.invoice_number }}
              </b-table-column>

              <b-table-column field="claimed_amount" label="Claimed Amount (USD)" width="200" numeric v-slot="props" >
                {{ props.row.claimed_amount }}
              </b-table-column>

              <b-table-column field="custom_officer" label="Custom Office" width="200" numeric v-slot="props" centered>
...
export default {
  ...
  data() {
    return {
      ...
      exportWizard: new TransactionExportWizard("Merchant Report"),
  ...
  methods: {
    ...
    showPurchaseListModal: function (merchant){
      const self = this
    ...
    generateXlsx: function (){
      ...
      self.exportWizard.exportToXlsx(
          ...
          self.fromDate,
          self.toDate,
          "merchantReport_" + self.formatDate(new Date()),
          self.tableHeaders,
          self.filteredList
      )
    },
    ...
    loadData: function (){
      ...
      NetworkManager.apiRequest('api/dutyfree/DFCustom/merchant-report', data, function (e){
        if(e.statusCode === 200){
