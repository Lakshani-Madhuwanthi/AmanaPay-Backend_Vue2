  ...
  <section>
    ...
    <div class="card-content" style="overflow: auto; height: 83vh">
      ...
      <b-table
        ...
        <b-table-column field="company" label="Company" sortable v-slot="props" width="200">
          {{ props.row.company }}
        </b-table-column>

        <b-table-column field="mobile_number" label="Selected Policy" sortable v-slot="props" width="200">
          {{ props.row.selected_policy }}
        </b-table-column>

        <b-table-column field="mobile_number" label="Receiver Email" sortable v-slot="props" width="200">
          {{ props.row.receiver_email }}
        </b-table-column>

        <b-table-column field="receiver_mobile_number" label="Receiver Mobile Number" sortable v-slot="props" width="200">
          {{ props.row.receiver_mobile_number }}
        </b-table-column>
        ...
        <b-table-column field="insurance_payment_time" label="Insurance Payment Time" sortable v-slot="props">
          <span class="tag is-success expanded-col">{{ getDateTimeForDisplaying(props.row.insurance_payment_time) }}</span>
        </b-table-column>
