                            ...
                            <div class="card-content">
                                <div style="height: 120px">
                                    <div class="columns">
                                        ...
                                        <div class="column has-text-right">
                                            <span style="font-weight: bold; font-size: 18px; color: #7A57D5">{{
                                                requestData.value_df_claims }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-content">
                                <div style="height: 120px">
                                    <div class="columns">
                                        ...
                                        <div class="column has-text-right">
                                            <span style="font-weight: bold; font-size: 18px; color: #7A57D5">{{
                                                requestData.cutom_approved }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-content">
                                <div style="height: 120px">
                                    <div class="columns">
                                        ...
                                        <div class="column has-text-right">
                                            <span style="font-weight: bold; font-size: 18px; color: #7A57D5">{{
                                                requestData.cutom_rejected }}</span>
                                        </div>
                                    </div>
  ...
  methods: {
    ...
    loadData: function (){
      ...
      setTimeout(() => {
        ...
        NetworkManager.apiRequest('api/DFDashboard/custom-dfrequest-data', data, function (e){
          if(e.statusCode === 200){
